...
export const env = createEnv({
  ...
  server: {
    ...
    ALLOW_PRIVATE_CUSTOM_ENDPOINTS:        z.boolean().optional(),                 // Opt-in (self-hosted only): let custom LLM endpoints reach private/reserved/loopback hosts. Metadata endpoints remain blocked.
